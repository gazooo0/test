...
●　検索時に情報公開されていれば特別登録馬や出走想定馬のサーチも可能です。<br>
</div>
...
st.markdown("■特別登録：前週日曜日の18時前後（G1レースは前々週に特別登録となりますが対応していません）<br>■出走想定：水曜日の20時前後<br>■出走確定：木曜日の19時前後<br>■枠順確定：レース前日の11時前後")
